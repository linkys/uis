    ...
    <div class="app-row">
        <div class="app-col app-col-3">
            <div class="app-form-group">
                ...
                <input type="text" class="app-form-text" name="studyField" value="<?php echo isset($tab_2['studyField']) ? $tab_2['studyField'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-3">
            <div class="app-form-group">
                <label class="app-form-label">Country of Study</label>
                <input type="text" class="app-form-text country-select" name="studyCountry" value="<?php echo isset($tab_2['studyCountry']) ? $tab_2['studyCountry'] : '' ?>">
            </div>
        </div>
    </div>
        ...
        <div class="app-col">
            <div class="app-form-group">
                ...
                <div class="app-radio-group">
                    <label class="radio">
                        <input type="radio" name="education" value="Yes" <?php echo isset($tab_2['education']) && $tab_2['education'] == 'Yes' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        Yes
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="education" value="No" <?php echo isset($tab_2['education']) ? ($tab_2['education'] == 'No' ? 'checked' : '') : 'checked'  ?>>
                        <span class="pseudo-radio"></span>
                        No
                    </label>
                </div>
        ...
        <div class="app-col app-col-4">
            <div class="app-form-group">
                ...
                <div class="app-form-text_sm">
                    <input type="number" class="app-form-text" name="educationYears" value="<?php echo isset($tab_2['educationYears']) ? $tab_2['educationYears'] : '' ?>">
                </div>
            </div>
        </div>
    </div>
