<form action="<?php echo esc_url( admin_url('admin-post.php') ) ?>" method="post">
        ...
        <div class="app-col">
            <div class="app-form-group">
                ...
                <div class="app-radio-group">
                    <label class="radio">
                        <input type="radio" name="adaptability-1" value="Yes" <?php echo isset($tab_5['adaptability-1']) && $tab_5['adaptability-1'] == 'Yes' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        Yes
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-1" value="No" <?php echo isset($tab_5['adaptability-1']) ? ($tab_5['adaptability-1'] == 'No' ? 'checked' : '') : 'checked'  ?>>
                        <span class="pseudo-radio"></span>
                        No
                    </label>
                </div>
    ...
    <div class="app-row">
        <div class="app-col">
            <div class="app-form-group">
                ...
                <div class="app-radio-group">
                    <label class="radio">
                        <input type="radio" name="adaptability-2" value="Yes" <?php echo isset($tab_5['adaptability-2']) && $tab_5['adaptability-2'] == 'Yes' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        Yes
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-2" value="No" <?php echo isset($tab_5['adaptability-2']) ? ($tab_5['adaptability-2'] == 'No' ? 'checked' : '') : 'checked'  ?>>
                        <span class="pseudo-radio"></span>
                        No
                    </label>
                </div>
    ...
    <div class="app-row">
        <div class="app-col">
            <div class="app-form-group">
                ...
                <div class="app-radio-group">
                    <label class="radio">
                        <input type="radio" name="adaptability-3" value="Yes" <?php echo isset($tab_5['adaptability-3']) && $tab_5['adaptability-3'] == 'Yes' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        Yes
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-3" value="No" <?php echo isset($tab_5['adaptability-3']) ? ($tab_5['adaptability-3'] == 'No' ? 'checked' : '') : 'checked'  ?>>
                        <span class="pseudo-radio"></span>
                        No
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-3" value="N/A" <?php echo isset($tab_5['adaptability-3']) && $tab_5['adaptability-3'] == 'N/A' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        N/A
                    </label>
                </div>
    ...
    <div class="app-row">
        <div class="app-col">
            <div class="app-form-group">
                ...
                <div class="app-radio-group">
                    <label class="radio">
                        <input type="radio" name="adaptability-4" value="Yes" <?php echo isset($tab_5['adaptability-4']) && $tab_5['adaptability-4'] == 'Yes' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        Yes
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-4" value="No" <?php echo isset($tab_5['adaptability-4']) ? ($tab_5['adaptability-4'] == 'No' ? 'checked' : '') : 'checked'  ?>>
                        <span class="pseudo-radio"></span>
                        No
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-4" value="I do not have a spouse" <?php echo isset($tab_5['adaptability-4']) && $tab_5['adaptability-4'] == 'I do not have a spouse' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        I do not have a spouse
                    </label>
                </div>
        ...
        <div class="app-col app-col-6">
            <div class="app-form-group">
                ...
                <div class="app-form-text_sm">
                    <input type="number" class="app-form-text" name="partnerEducationYears" value="<?php echo isset($tab_5['partnerEducationYears']) ? $tab_5['partnerEducationYears'] : '' ?>">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="app-row">
        <div class="app-col">
            <div class="app-form-group">
                ...
                <div class="app-radio-group">
                    <label class="radio">
                        <input type="radio" name="adaptability-5" value="Yes" <?php echo isset($tab_5['adaptability-5']) && $tab_5['adaptability-5'] == 'Yes' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        Yes
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-5" value="No" <?php echo isset($tab_5['adaptability-5']) ? ($tab_5['adaptability-5'] == 'No' ? 'checked' : '') : 'checked'  ?>>
                        <span class="pseudo-radio"></span>
                        No
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="adaptability-5" value="I do not have a spouse" <?php echo isset($tab_5['adaptability-5']) && $tab_5['adaptability-5'] == 'I do not have a spouse' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        I do not have a spouse
                    </label>
                </div>
    ...
    <div class="app-row">
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <select name="partnerEnglishReading">
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <select name="partnerEnglishListening">
                    <?php foreach($levels as $item) : ?>
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <select name="partnerEnglishWriting">
                    <?php foreach($levels as $item) : ?>
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <select name="partnerEnglishSpeaking">
                    <?php foreach($levels as $item) : ?>
    ...
    <div class="app-row">
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Reading:</label>
                <select name="partnerFrenchReading">
                    <?php foreach($levels as $item) : ?>
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Listening:</label>
                <select name="partnerFrenchListening">
                    <?php foreach($levels as $item) : ?>
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Writing:</label>
                <select name="partnerFrenchWriting">
                    <?php foreach($levels as $item) : ?>
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Speaking:</label>
                <select name="partnerFrenchSpeaking">
                    <?php foreach($levels as $item) : ?>
