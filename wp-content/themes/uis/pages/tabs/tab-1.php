    ...
    <div class="app-row">
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <input type="text" name="firstName" class="app-form-text" value="<?php echo isset($tab_1['firstName']) ? $tab_1['firstName'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Middle name</label>
                <input type="text" name="middleName" class="app-form-text" value="<?php echo isset($tab_1['middleName']) ? $tab_1['middleName'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Last name</label>
                <input type="text" name="lastName" class="app-form-text" value="<?php echo isset($tab_1['lastName']) ? $tab_1['lastName'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <div class="app-radio-group app-radio-group-text">
                    <label class="radio-text">
                        <input type="radio" name="gender" value="female" <?php echo isset($tab_1['gender']) && $tab_1['gender'] == 'female' ? 'checked' : ''  ?>>
                        <span>Female</span>
                    </label>
                    <label class="radio-text">
                        <input type="radio" name="gender" value="male" <?php echo isset($tab_1['gender']) ? ($tab_1['gender'] == 'male' ? 'checked' : '') : 'checked'  ?>>
                        <span>Male</span>
                    </label>
                </div>
            </div>
    ...
    <div class="app-row">
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <input type="email" name="email" class="app-form-text" value="<?php echo isset($tab_1['email']) ? $tab_1['email'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">*Another email address</label>
                <input type="email" name="anotherEmail" class="app-form-text" value="<?php echo isset($tab_1['anotherEmail']) ? $tab_1['anotherEmail'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Phone number</label>
                <input type="text" name="phone" class="app-form-text" value="<?php echo isset($tab_1['phone']) ? $tab_1['phone'] : '' ?>">
        ...
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <input type="text" name="country" class="app-form-text country-select" value="<?php echo isset($tab_1['country']) ? $tab_1['country'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
        </div>
    ...
    <div class="app-row">
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <input type="text" name="street" class="app-form-text" value="<?php echo isset($tab_1['street']) ? $tab_1['street'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">City</label>
                <input type="text" name="city" class="app-form-text" value="<?php echo isset($tab_1['city']) ? $tab_1['city'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                <label class="app-form-label">Zip code / Postal code</label>
                <input type="text" name="zipcode" class="app-form-text" value="<?php echo isset($tab_1['zipcode']) ? $tab_1['zipcode'] : '' ?>">
            </div>
        </div>
        <div class="app-col app-col-5th">
            <div class="app-form-group">
                ...
                <div class="input-icon">
                    <input type="text" name="dob" class="app-form-text datepicker" placeholder="dd / mm / yyyy" value="<?php echo isset($tab_1['dob']) ? $tab_1['dob'] : '' ?>">
        ...
        <div class="app-col">
            <div class="app-form-group">
                ...
                <div class="app-radio-group">
                    <label class="radio">
                        <input type="radio" name="health" value="Yes" <?php echo isset($tab_1['health']) && $tab_1['health'] == 'Yes' ? 'checked' : ''  ?>>
                        <span class="pseudo-radio"></span>
                        Yes
                    </label>
                    <br />
                    <label class="radio">
                        <input type="radio" name="health" value="No" <?php echo isset($tab_1['health']) ? ($tab_1['health'] == 'No' ? 'checked' : '') : 'checked'  ?>>
                        <span class="pseudo-radio"></span>
                        No
                    </label>
                </div>
